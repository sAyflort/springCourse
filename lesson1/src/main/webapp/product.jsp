        ...
        <div class="col-12">
            <table class="table table-bordered my-2">
                ...
                <%  Object object = request.getAttribute("products");
                    List<Product> products = object instanceof Product ? Arrays.asList(new Product[]{(Product) object}) : (List<Product>) object;
                    for (Product product: products) { %>

                <tr>
                    <th scope="row"><a href="<%=request.getContextPath() + "/product/" + product.getId()%>"><%= product.getId() %></th>
